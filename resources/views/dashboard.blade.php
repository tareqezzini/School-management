                ...
                <div class="row">
                    <div class="col-sm-6">
                        <h4 class="mb-20" style="font-family: 'Cairo', sans-serif">
                            {{ trans('dashboard.admin_dashboard') }}</h4>
                    </div>
                    <div class="col-sm-6">
                    ...
                    <div class="card card-statistics h-100">
                        <div class="card-body">
                            <div class="clearfix">
                                ...
                                <div class="float-right text-right">
                                    <p class="card-text text-dark">{{ trans('dashboard.number_teachers') }}</p>
                                ...
                                <div class="d-block d-md-flex justify-content-between">
                                    <div class="d-block w-100">
                                        <h5 style="font-family: 'Cairo', sans-serif" class="card-title">
                                            {{ trans('main_trans.last_operations') }}</h5>
                                    </div>
                                            ...
                                            <table style="text-align: center"
                                                ...
                                                <thead>
                                                    <tr class="table-info text-danger">
                                                        ...
                                                        <th>{{ trans('Students_trans.added_date') }}</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                        ...
                                        <div class="table-responsive mt-15">
                                            <table style="text-align: center"
                                                ...
                                                <thead>
                                                    <tr class="table-info text-danger">
                                                        <th>#</th>
                                                        <th>{{ trans('accounts.invoices_date') }}</th>
                                                        <th>{{ trans('Students_trans.name') }}</th>
                                                        <th>{{ trans('Students_trans.Grade') }}</th>
                                                        <th>{{ trans('Students_trans.classrooms') }}</th>
                                                        <th>{{ trans('Students_trans.section') }}</th>
                                                ...
                                                <tbody>
                                                    @forelse(\App\Models\FeesInvoice::latest()->take(10)->get() as $invoice)
                                                        <tr>
                                                            <td>{{ $loop->iteration }}</td>
