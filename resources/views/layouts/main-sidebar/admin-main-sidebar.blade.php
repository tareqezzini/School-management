    ...
    <ul class="nav navbar-nav side-menu" id="sidebarnav">
        ...
        <li>
            ...
            <ul id="Accounts-menu" class="collapse" data-parent="#sidebarnav">
                <li> <a href="{{ route('Fees.index') }}">{{ trans('main_trans.StudyFees') }}</a> </li>
                ...
                <li> <a href="{{ route('ProcessingFee.index') }}"> {{ trans('main_trans.PaymentFee') }}</a> </li>
                <li> <a href="{{ route('Payment_students.index') }}">{{ trans('main_trans.billsExchange') }}</a>
                </li>
            </ul>
        </li>
        ...
        <li>
            ...
            <ul id="Exams-icon" class="collapse" data-parent="#sidebarnav">
                ...
                <li> <a href="{{ route('Questions_quizzes.index') }}">{{ trans('main_trans.list_questions') }}</a>
                </li>
            </ul>
        </li>
        ...
        <li>
            ...
            <ul id="Onlineclasses-icon" class="collapse" data-parent="#sidebarnav">
                <li> <a href="{{ route('online_classes.index') }}">{{ trans('main_trans.OnlineClasses_zoom') }}</a>
                </li>
            </ul>
        </li>
