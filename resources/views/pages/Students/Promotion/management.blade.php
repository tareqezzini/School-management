                                ...
                                <table id="datatable" class="table  table-hover table-sm table-bordered p-0"
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="alert-danger"> {{ trans('Students_trans.prev_stage') }}</th>
                                            <th class="alert-danger">{{ trans('Students_trans.academic_year') }}</th>
                                            <th class="alert-danger">{{ trans('Students_trans.previous_class') }}</th>
                                            <th class="alert-danger">{{ trans('Students_trans.previous_class') }}
                                            </th>
                                            <th class="alert-success">{{ trans('Students_trans.current_school_stage') }}
                                            </th>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <button type="button" class="btn btn-outline-danger"
                                                        data-toggle="modal"
                                                        data-target="#Delete_one{{ $promotion->id }}">{{ trans('Students_trans.student_graduated') }}</button>
                                                    <button type="button" class="btn btn-outline-success"
                                                        data-toggle="modal"
                                                        data-target="#">{{ trans('Students_trans.return_student') }}</button>
                                                </td>
                                            </tr>
