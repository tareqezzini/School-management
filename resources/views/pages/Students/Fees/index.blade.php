                                ...
                                <table id="datatable" class="table  table-hover table-sm table-bordered p-0"
                                    ...
                                    <thead>
                                        <tr class="alert-success">
                                            ...
                                            <th>{{ trans('accounts.desc') }}</th>
                                            <th>{{ trans('accounts.processes') }}</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        @foreach ($fees as $fee)
                                            <tr>
                                                ...
                                                <td>{{ $fee->title }}</td>
                                                <td><?php echo $fee->Fee_type == 1 ? trans('accounts.fees_study') : trans('accounts.fees_bus'); ?></td>
