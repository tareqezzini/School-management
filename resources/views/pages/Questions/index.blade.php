        ...
        <div class="card card-statistics h-100">
            <div class="card-body">
                <div class="col-xl-12 mb-30">
                    <div class="card card-statistics h-100">
                        <div class="card-body">
                            <a href="{{ route('Questions_quizzes.create') }}" class="btn btn-success btn-sm" role="button"
                                aria-pressed="true">{{ trans('exams_trans.add_question') }}</a><br><br>
                                    ...
                                    <tbody>
                                        @foreach ($questions as $question)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('Questions_quizzes.edit', $question->id) }}"
