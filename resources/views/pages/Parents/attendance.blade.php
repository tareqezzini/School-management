        ...
        <div class="col-md-12 mb-30">
            <div class="card card-statistics h-100">
                <div class="card-body">
                    ...
                    <form method="post" action="{{ route('childrenAttendance.search') }}" autocomplete="off">
                        @csrf
                        <h6 style="font-family: 'Cairo', sans-serif;color: blue">{{ trans('attendance.info_search') }}</h6>
                        <br>
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="student">{{ trans('attendance.students') }}</label>
                            ...
                            <div class="card-body datepicker-form">
                                <div class="input-group" data-date-format="yyyy-mm-dd">
                                    <input type="text" class="form-control range-from date-picker-default"
                                        placeholder="{{ trans('attendance.date_start') }}" required name="from">
                                    <span class="input-group-addon">{{ trans('attendance.to') }}</span>
                                    <input class="form-control range-to date-picker-default"
                                        placeholder="{{ trans('attendance.date_end') }}" type="text" required
                                        name="to">
                                </div>
                            </div>
