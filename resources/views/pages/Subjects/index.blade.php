...
@section('css')
    @toastr_css
@section('title')
    {{ trans('exams_trans.list_subject') }}
@stop
@endsection
@section('page-header')
<!-- breadcrumb -->
                    ...
                    <div class="card card-statistics h-100">
                        <div class="card-body">
                            <a href="{{ route('subjects.create') }}" class="btn btn-success btn-sm" role="button"
                                aria-pressed="true">{{ trans('exams_trans.add_subject') }}</a><br><br>
                                ...
                                <table id="datatable" class="table  table-hover table-sm table-bordered p-0"
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th>{{ trans('exams_trans.grade') }}</th>
                                            <th>{{ trans('exams_trans.sections') }}</th>
                                            <th>{{ trans('exams_trans.teacher_name') }}</th>
                                                        ...
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 style="font-family: 'Cairo', sans-serif;"
                                                                    ...
                                                                    {{ trans('exams_trans.delete_subject') }}</h5>
