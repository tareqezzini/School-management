    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 style="font-family: 'Cairo', sans-serif;" class="modal-title" id="exampleModalLabel">{{ trans('accounts.{{ trans('accounts.') }}') }}</h5>
            ...
            <div class="modal-body">
                <form action="{{ route('Payment_students.destroy', 'test') }}" method="post">
                    ...
                    <h5 style="font-family: 'Cairo', sans-serif;">{{ trans('main_trans.delete') }}</h5>
