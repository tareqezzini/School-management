                    ...
                    <div class="row">
                        <div class="col-md-6 border-right-2 border-right-blue-400">
                            <div class="form-group row">
                                <label
                                    class="col-lg-4 col-form-label font-weight-semibold">{{ trans('Settings.name_school') }}<span
                            ...
                            <div class="form-group row">
                                <label for="current_session"
                                    class="col-lg-4 col-form-label font-weight-semibold">{{ trans('Settings.current_year') }}<span
                                        class="text-danger">*</span></label>
                                <div class="col-lg-8">
                            ...
                            <div class="form-group row">
                                <label
                                    class="col-lg-4 col-form-label font-weight-semibold">{{ trans('Settings.shortcut_name') }}</label>
                                <div class="col-lg-8">
                            ...
                            <div class="form-group row">
                                <label
                                    class="col-lg-4 col-form-label font-weight-semibold">{{ trans('Settings.phone_number') }}</label>
                                <div class="col-lg-8">
                            ...
                            <div class="form-group row">
                                <label
                                    class="col-lg-4 col-form-label font-weight-semibold">{{ trans('Settings.email') }}</label>
                                <div class="col-lg-8">
                            ...
                            <div class="form-group row">
                                <label
                                    class="col-lg-4 col-form-label font-weight-semibold">{{ trans('Settings.address') }}<span
                                        class="text-danger">*</span></label>
                                <div class="col-lg-8">
                            ...
                            <div class="form-group row">
                                <label class="col-lg-4 col-form-label font-weight-semibold">
                                    {{ trans('Settings.start_semester') }} </label>
                                <div class="col-lg-8">
                            ...
                            <div class="form-group row">
                                <label
                                    class="col-lg-4 col-form-label font-weight-semibold">{{ trans('Settings.end_semester') }}</label>
                                <div class="col-lg-8">
                            ...
                            <div class="form-group row">
                                <label
                                    class="col-lg-4 col-form-label font-weight-semibold">{{ trans('Settings.logo') }}</label>
                                <div class="col-lg-6">
                                    <div class="mb-3">
